...
import com.example.smartfarmer.adapters.BarterAdapter;
import com.example.smartfarmer.auth.SupabaseAuthHelper;
import com.example.smartfarmer.models.BarterListing;
    ...
    private void sendRequest(BarterListing listing, String offer) {
        ...
        supabaseAuth.createBarterRequest(req, new SupabaseAuthHelper.AuthCallback() {
            ...
            public void onSuccess(String data) {
                ...
                runOnUiThread(() -> Toast.makeText(BarterActivity.this, R.string.request_sent, Toast.LENGTH_SHORT).show());
            }
