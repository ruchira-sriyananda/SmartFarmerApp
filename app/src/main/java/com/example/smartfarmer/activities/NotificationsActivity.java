...
import com.example.smartfarmer.adapters.NotificationAdapter;
import com.example.smartfarmer.auth.SupabaseAuthHelper;
import com.example.smartfarmer.models.Notification;
...
public class NotificationsActivity extends BaseActivity {
    ...
    private com.example.smartfarmer.models.NotificationRepository notificationRepository;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationRepository = new com.example.smartfarmer.models.NotificationRepository(this);
    ...
    private void fetchNotifications() {
        ...
        notificationRepository.getNotifications(sessionManager.getUserId(), new com.example.smartfarmer.models.NotificationRepository.NotificationCallback() {
            @Override
