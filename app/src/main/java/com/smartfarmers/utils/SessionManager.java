...
public class SessionManager {
    ...
    public void saveUser(com.smartfarmers.models.User user) {
    ...
    public void clearSession() {
        ...
        new Thread(() -> {
            try {
                com.smartfarmers.models.ChatDatabase db = com.smartfarmers.models.ChatDatabase.getInstance(context);
