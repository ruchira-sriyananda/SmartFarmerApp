...
import com.smartfarmers.adapters.PostAdapter;
...
public class MainActivity extends BaseActivity {
    ...
    private com.smartfarmers.models.PostRepository postRepository;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postRepository = new com.smartfarmers.models.PostRepository(this);
    ...
    private void fetchPosts() {
        ...
        postRepository.getPosts(sessionManager.getUserId(), new com.smartfarmers.models.PostRepository.PostCallback() {
            @Override
