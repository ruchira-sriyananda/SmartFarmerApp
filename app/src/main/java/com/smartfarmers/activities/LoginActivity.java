...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Clear any stuck login state to prevent 12500 errors
    ...
    private void initAuth() {
        ...
        // Get the Client ID automatically generated by the google-services plugin
        // This is the most reliable way to avoid 12500 errors
        int autoResId = getResources().getIdentifier("default_web_client_id", "string", getPackageName());
        String webClientId;
        if (autoResId != 0) {
            webClientId = getString(autoResId);
        } else {
            webClientId = getString(R.string.google_web_client_id).trim();
        }
        
        Log.d(TAG, "Initializing Google Sign-In with: " + webClientId);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                String errorMsg = com.google.android.gms.common.api.CommonStatusCodes.getStatusCodeString(statusCode);
                Log.e(TAG, "Google API Error: " + statusCode + " (" + errorMsg + ")", e);
                
                if (statusCode == 12501) {
                    // Sign-in cancelled by user, just hide error
                    tvError.setVisibility(View.GONE);
                } else if (statusCode == 12500) {
                    showError("Google Sign-In Internal Error (12500). Please check your internet or Google Play Services.");
                } else if (statusCode == 10) {
                    showError("Developer Error (10): Please check SHA-1 and Web Client ID configuration.");
                } else {
                    showError("Google Error (" + statusCode + "): " + errorMsg);
                }
            }
        }
    }
                ...
                runOnUiThread(() -> {
                    ...
                    if (response.isSuccessful()) {
                        try {
                            ...
                            showError("Failed to process login data. Please try again.");
                        }
                    } else {
                        Log.e(TAG, "Supabase Auth failed: " + response.code() + " - " + responseBody);
                        showError("Authentication failed (Error " + response.code() + ").");
                    }
                });
            }
        });
            ...
            public void onSuccess(String profileJson) {
                runOnUiThread(() -> {
                    try {
                        ...
                        com.smartfarmers.models.User user = new com.smartfarmers.models.User();
