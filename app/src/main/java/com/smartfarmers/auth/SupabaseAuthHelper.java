...
public class SupabaseAuthHelper {
    ...
    public void saveUserDetails(com.smartfarmers.models.User user, AuthCallback callback) {
        try {
            JSONObject json = new JSONObject();
    ...
    public void updateMessage(String messageId, String newContent, String seed, AuthCallback callback) {
        ...
        try {
            JSONObject json = new JSONObject();
            json.put("message_text", com.smartfarmers.utils.EncryptionUtils.encrypt(newContent, seed));
            RequestBody body = RequestBody.create(MediaType.parse("application/json"), json.toString());
            Request request = new Request.Builder()
    ...
    public void createBarterListing(com.smartfarmers.models.BarterListing listing, AuthCallback callback) {
        try {
            JSONObject json = new JSONObject();
    ...
    public void createBarterRequest(com.smartfarmers.models.BarterRequest barterReq, AuthCallback callback) {
        try {
            JSONObject json = new JSONObject();
    ...
    public void checkUserSubscription(String userId, AuthCallback callback) {
        String url = SUPABASE_URL + "/rest/v1/payment_transactions?user_id=eq." + userId + 
                     "&package_id=not.is.null&status=eq.completed&select=package_id";
        Request request = new Request.Builder()
                .url(url)
                .header("apikey", SUPABASE_ANON_KEY)
                .header("Authorization", getAuthHeader())
