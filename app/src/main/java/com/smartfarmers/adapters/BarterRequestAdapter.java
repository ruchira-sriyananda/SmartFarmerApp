...
public class BarterRequestAdapter extends RecyclerView.Adapter<BarterRequestAdapter.ViewHolder> {
    ...
    public interface OnRequestActionListener {
        ...
        void onChat(BarterRequest request);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (isReceivedType) {
            ...
            } else if ("accepted".equalsIgnoreCase(request.getRequestStatus())) {
        ...
        holder.btnChat.setOnClickListener(v -> {
            if (listener != null) listener.onChat(request);
        });
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            btnChat = itemView.findViewById(R.id.btnChatRequest);
